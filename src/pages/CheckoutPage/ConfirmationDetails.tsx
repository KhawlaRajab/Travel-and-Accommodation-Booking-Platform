            ...
            <Container sx={{marginTop:12 ,textAlign:'center'}}>
                ...
                <TableContainer component={Paper} sx={{ width: '600px', marginX:'auto' }}>
                    <Table>
                      <TableBody>
                       <TableRow>
                             <TableCell component="th" scope="row">customerName</TableCell>
                            <TableCell >{data?.customerName}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell component="th" scope="row">hotelName</TableCell>
                            <TableCell >{data?.hotelName}</TableCell>
                         </TableRow>
                         <TableRow>
                            <TableCell component="th" scope="row">roomType</TableCell>
                            <TableCell >{data?.roomType}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell component="th" scope="row">bookingDateTime</TableCell>
                            <TableCell >{data?.bookingDateTime}</TableCell>
                        </TableRow>    
                        <TableRow>
                             <TableCell component="th" scope="row">roomNumber</TableCell>
                            <TableCell >{data?.roomNumber}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell component="th" scope="row">totalCost</TableCell>
                            <TableCell >{data?.totalCost}</TableCell>
                         </TableRow>
                         <TableRow>
                            <TableCell component="th" scope="row">bookingStatus</TableCell>
                            <TableCell >{data?.bookingStatus}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell component="th" scope="row">confirmationNumber</TableCell>
                            <TableCell >{data?.confirmationNumber}</TableCell>
                        </TableRow>   
                        <TableRow>
                            <TableCell component="th" scope="row">paymentMethod</TableCell>
