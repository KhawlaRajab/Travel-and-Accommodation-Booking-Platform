import { Card, Stack, CardMedia, CardContent, Typography, Rating, Button } from "@mui/material";
               ...
               />
                <CardContent>
                    <Stack direction={'row'} spacing={2} alignItems={'center'} justifyItems={'center'}>
                        <Typography variant='h6' color='primary'>{searchResult.hotelName}</Typography>
                        <Typography variant='subtitle1' >{searchResult.roomType}</Typography>
                    </Stack>
                    <Typography variant='body2' color='textDisabled'>{searchResult.cityName}</Typography>
                    <Stack direction={'row'} spacing={4} alignItems={'center'} justifyItems={'center'} paddingY={1}>
