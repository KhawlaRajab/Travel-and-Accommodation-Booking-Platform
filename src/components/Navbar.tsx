import { AppBar, Box, Menu, MenuItem, Toolbar, Typography, styled,Button,IconButton, Badge } from "@mui/material";
...
const Navbar: React.FC = () => {
    ...
    return (
        <AppBar position="fixed">
            ...
            <Toolbar >
                <Box sx={{ display: { xs: 'none', md: 'flex'},alignItems: 'center', flexGrow: 1, justifyContent:'space-between'  }}>               
                    <Box>
                       <Typography variant="h6" component='span' sx={{ paddingRight: '130px' }}>
                        TravelZ
                       </Typography>
                       <Button color='inherit' onClick={()=>navigate('/home')}>Home</Button>
                       <Button color='inherit' onClick={()=>navigate('/SearchResultPage')}>Search</Button>
                    </Box>
