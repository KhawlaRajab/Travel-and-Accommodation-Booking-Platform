...
const SearchBar: React.FC = () => {
  ...
  const handleDateChange = (item: any) => {
    ...
    formik.setFieldValue(
      "checkOutDate",
      `${item.selection.endDate.toLocaleDateString()}`
    );
  };
              ...
              >
                ...
                >
                  <CountPeople
                    type="Adults"
                    defaultCount={2}
                    onChange={(count) => formik.setFieldValue("adults", count)}
                  />
                  <CountPeople
                    type="Children"
                    defaultCount={0}
                    onChange={(count) =>
                      formik.setFieldValue("children", count)
                    }
                  />
                  <CountPeople
                    type="Rooms"
                    defaultCount={1}
                    onChange={(count) =>
                      formik.setFieldValue("numberOfRooms", count)
                    }
                  />
                </Stack>
              </Popover>
